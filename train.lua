...
function Trainer:train(epoch, dataloader)
   ...
   print((' | Epoch: [%d][%d, %d]    Time %.3f  Err %1.4f  top1 %7.3f top5 %7.3f'):format(
         epoch, trainSize, N, timer:time().real, lossSum/N, top1Sum / N, top5Sum / N))
   timer:reset()
...
function Trainer:test(epoch, dataloader)
   ...
   print((' | Test: [%d][%d, %d]    Time %.3f  Err %1.4f  top1 %7.3f  top5 %7.3f'):format(
         epoch, size, N, timer:time().real, lossSum/N, top1Sum / N, top5Sum / N))
   timer:reset()
...
function Trainer:learningRate(epoch)
   ...
   elseif self.opt.dataset == 'tinyimagenet' then
